...
while($row=mysqli_fetch_array($query)){
                                    ?>
                                <a class="dropdown-item d-flex align-items-center" href="test-details?tid=<?php echo $row['id'];?>&&oid=<?php echo $row['OrderNumber'];?>">
                                    <div class="mr-3">
                            ...
                            <?php } ?>
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="new-test">Show All Alerts</a>
                            </div>
                        </li>
